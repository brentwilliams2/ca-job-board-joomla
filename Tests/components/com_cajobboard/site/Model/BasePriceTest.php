...
namespace Calligraphic\Cajobboard\Tests\Site\Model\Subscribe\Validation;

use Calligraphic\Cajobboard\Tests\Stubs\ValidatorTestCase;

/**
 * Test the BasePrice validator
 *
 * @covers Calligraphic\Cajobboard\Site\Model\Subscribe\Validation\BasePrice
 */
class BasePriceTest extends ValidatorTestCase
{
    ...
    $reflector     = new \ReflectionClass('Calligraphic\Cajobboard\Admin\Helper\EUVATInfo');
