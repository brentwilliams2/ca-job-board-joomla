 ...
 *
 * com_users reset/confirm.php template override
 *
...
<div class="reset-confirm<?php echo $this->pageclass_sfx?> well-lg bg-white">
	...
	<form action="<?php echo Route::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="form-validate form-horizontal">
