      ...
      <div id="form-login-username" class="form-group">
        ...
        <div class="input-group">
          <div class="input-group-addon">
            <span class="glyphicon glyphicon-user tip" title="<?php  echo JText::_('MOD_LOGIN_VALUE_USERNAME')  ?>">
            </span>
          </div>
	...
	<div id="form-login-password" class="form-group">
		<div class="controls">
          ...
          <span class="input-group-addon">
            <span class="glyphicon glyphicon-lock tip" title="<?php  echo JText::_('JGLOBAL_PASSWORD')  ?>">
            </span>
          </span>
