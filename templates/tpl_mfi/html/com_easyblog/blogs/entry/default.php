...
<div itemscope itemtype="http://schema.org/BlogPosting" data-blog-post>
    <div id="entry-<?php echo $post->id; ?>" class="eb-entry fd-cf" data-blog-posts-item data-id="<?php echo $post->id;?>" data-uid="<?php echo $post->getUid();?>">
		...
		<?php //MFI - Brent removed the tools area and added float right to edit button - otherwise, there was a top margin above title ?>
        ...
        <div class="eb-entry-tools row-table">
			...
			*/ ?>
            <?php if (!$preview) { ?>
            <div class="col-cell cell-tight" style="float:right;">
		...
		*/ ?>
		...
		<?php //MFI - Brent added avatar to individual blog heading area ?>
        ...
        <div class="eb-entry-head">
            ...
            <div class="eb-entry-meta text-muted">
				...
				<?php //MFI - Brent added print button here */ ?>
        ...
        <div class="eb-entry-body type-<?php echo $post->posttype; ?> clearfix">
			...
			<?php //MFI - Brent moved the ratings above the social buttons ?>
