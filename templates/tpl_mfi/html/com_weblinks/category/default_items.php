 ...
 *
 * com_weblinks category/default_itmes.php template partial override
 *
      ...
      <?php if ($this->params->get('filter_field') != 'hide') :?>
        ...
        <div class="btn-group">
          ...
          <label class="filter-search-lbl element-invisible" for="filter-search">
            ...
            <?php echo Text::_('COM_WEBLINKS_FILTER_LABEL') . '&#160;'; ?>
          ...
          <input
            ...
            title="<?php echo Text::_('COM_WEBLINKS_FILTER_SEARCH_DESC'); ?>"
      ...
      <?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
        ...
        <?php if ($canEdit) : ?>
          <span class="list-edit pull-left width-50">
            <?php echo HTMLHelper::_('icon.create_edit', $item, $params); ?>
          </span>
        <?php endif; ?>
        ...
        <div class="list-title">
          ...
          <?php if (($this->params->get('show_link_description')) and ($item->description != '')) : ?>
            ...
            <?php  if (isset($images->image_first) and !empty($images->image_first)) : ?>
              ...
              <div class="img-intro-<?php echo htmlspecialchars($imgfloat); ?> img-responsive">]
                <img
                  ...
                  class="img-responsive <?php echo $captionClass;?>"
                >
              </div>
...
<?php endforeach; ?>
		...
		<?php /* if ($canCreate) : // TODO This is not working due to some problem in the router, I think. Ref issue #23685 ?>
			<?php echo HTMLHelper::_('icon.create', $item, $item->params); ?>
    <?php  endif;
    */ ?>
