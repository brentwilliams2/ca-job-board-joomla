    ...
    <div class="eb-composer-toolbar-group row-table">
        ...
        <div class="col-cell cell-tight toolbar-right mobile-hide">
            <div class="eb-composer-toolbar-group row-table">
				...
				<?php //MFI - Brent added link to blogging guidelines  ?>
                <div class="eb-composer-toolbar-item is-button col-cell eb-document-add-cover-button" data-id="cover">
                    <i></i>
                    <span><a href="/apartment-groups/viewdiscussion/357-blogging-guidelines-and-tips?groupid=120" target="_blank" style="color:#fff;">Guidelines</a></span>
                    <span style="display: none;"><?php echo JText::_('COM_EASYBLOG_COMPOSER_COVER');?></span>
                </div>				
