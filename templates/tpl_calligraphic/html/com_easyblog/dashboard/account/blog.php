...
<div class="eb-box">
	...
	<div class="eb-box-body">
		...
		<div class="form-horizontal">
			...
			<?php } ?>
			<div class="form-group">
				<label  class="col-md-3 control-label"><?php echo JText::_('COM_EASYBLOG_DASHBOARD_BLOGGER_BIOGRAPHICAL_INFO');?><br />(Max 3 lines)</label><?php //MFI - Brent BW added note about max 3 lines ?>
				<div class="col-md-8">
        	    	...
        	    	<?php } else { ?>
                    	<textarea name="biography" class="form-control" placeholder="<?php echo JText::sprintf('COM_EASYBLOG_BIOGRAPHY_NOT_SET', $profile->getName()); ?>"><?php echo $profile->getBiography(true);?></textarea>
                    <?php } ?>
				</div>
			</div>
			<div class="form-group">
