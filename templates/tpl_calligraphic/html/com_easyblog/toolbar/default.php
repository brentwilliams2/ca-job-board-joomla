...
<div class="eb-header">
	...
	<?php //MFI - Brent added this section to add subscribe links ?>
	...
	<div class="eb-brand">
		<?php //For this "if" and the next, I added mentions of categories and tags, so the site blog name would be an h2 instead of an h1 ?>
	...
	<div role="navigation" class="eb-navbar fd-cf <?php echo $this->config->get('layout_responsive') ? ' eb-responsive' : ''; ?>">
		...
		<div class="eb-navbar-collapse collapse">
			...
			<ul class="eb-navbar-nav eb-navbar-right reset-list float-list">
	            <?php /*MFI - Brent moved to top if ($this->config->get('main_sitesubscription') && $this->acl->get('allow_subscription') && !$subscription->id) { ?>
	        		<li>
	        			<a class="eb-brand-email" href="javascript:void(0);"
	        				data-blog-subscribe
	        				data-type="site"
					...
					<div class="eb-navbar-dropdown dropdown-menu dropdown-menu-right">
						 <form class="eb-navbar-login" action="<?php echo JRoute::_( 'index.php' );?>" method="post">
							<div class="form-group">
								<label>
									<span><?php echo JText::_('COM_EASYBLOG_' . EB::getLoginType(true)) ?></span>
								...
								<input id="username" type="text" name="username" class="form-control" alt="<?php echo EB::getLoginType();?>" tabindex="31"/>
							</div>
							<div class="form-group">
								<label>
