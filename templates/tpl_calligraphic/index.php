 ...
 */
  ...
  // JHTML::_( 'behavior.mootools' );
	...
	$menu_colors 				= $this->params->get("menuColors", "blue");
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
	<head>
  	...
  	<?php
      require(_BASEPATH . DS . "utils.php");
      require(_BASEPATH . DS . "_partials" . DS . "head_includes.php");
    ?>
    ...
    class="<?php echo $fontstyle; ?> bc-<?php echo $menu_color; ?> iehandle"
  >
		<div id="page-bg">
		<!-- Begin Wrapper -->
		<div class="wrapper">
			...
			<div class="shadow-left">
				<div class="shadow-right">
                    ...
                    <!--Logo -->
                        ...
                        class="nounder"><img src="<?php echo $template_path; ?>/images/blank.gif"
                        border="0"
                        alt=""
                        id="logo"
                      /></a>
                    ...
                    <!--Font Buttons -->
										...
										<div id="accessibility">
											<div id="buttons">
												<a
                          href="<?php echo JROUTE::_($thisurl . "fontstyle=f-larger"); ?>"
                          title="Increase size"
                          class="large"
                        >
                          <span class="button">&nbsp;</span>
												...
												<a
                          href="<?php echo JROUTE::_($thisurl . "fontstyle=f-smaller"); ?>"
                          title="Decrease size"
                          class="small"
                        >
                          <span class="button">&nbsp;</span>
                    ...
                    <!--Search Module -->
  									...
  									<!-- Front Page Module to show an H1 -->
  									<?php if ($this->countModules('H1')) : ?>
									...
									<?php if($mtype == "splitmenu" and !empty($subnav)) : ?>
										<div id="sub-menu">
											<?php echo $subnav; ?>
										</div>
									<?php endif; ?>
