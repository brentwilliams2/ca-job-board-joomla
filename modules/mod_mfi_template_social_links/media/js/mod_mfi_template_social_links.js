 ...
 *
 * Stylings for modules template file
 *
...
(function($){
	...
	var MfiElements = function(id, fields, lang, element_field){
		var self = this;
	...
	MfiElements.prototype = {
		constructor: MfiElements,
		id: null,
		data: '',
		elements: [],
		fields: null,
	...
	window.MfiElements = MfiElements;
