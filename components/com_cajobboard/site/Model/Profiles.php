<?php
/**
 * Site Profiles for Persons Model. Uses core Joomla! user profile table (#__user_profiles)
 *
 ...
 */
class Profiles extends \Calligraphic\Cajobboard\Admin\Model\Profiles
{
  /*
