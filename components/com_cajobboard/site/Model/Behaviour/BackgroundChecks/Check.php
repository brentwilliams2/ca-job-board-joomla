 ...
 *
 */
namespace Calligraphic\Cajobboard\Site\Model\Behaviour\BackgroundChecks;

// no direct access
defined( '_JEXEC' ) or die;

class Check extends \Calligraphic\Cajobboard\Admin\Model\Behaviour\BackgroundChecks\Check
{
