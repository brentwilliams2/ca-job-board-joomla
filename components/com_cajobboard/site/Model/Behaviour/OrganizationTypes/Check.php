 ...
 *
 */
namespace Calligraphic\Cajobboard\Site\Model\Behaviour\OrganizationTypes;

// no direct access
defined( '_JEXEC' ) or die;

class Check extends \Calligraphic\Cajobboard\Admin\Model\Behaviour\OrganizationTypes\Check
{
