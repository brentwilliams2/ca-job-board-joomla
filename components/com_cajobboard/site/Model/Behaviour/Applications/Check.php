 ...
 *
 */
namespace Calligraphic\Cajobboard\Site\Model\Behaviour\Applications;

// no direct access
defined( '_JEXEC' ) or die;

class Check extends \Calligraphic\Cajobboard\Admin\Model\Behaviour\Applications\Check
{
