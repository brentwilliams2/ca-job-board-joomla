<?php
/**
 * Site Job Occupational Categories Model
 *
 ...
 * @property JobOccupationalCategoryGroup  $JobGroup  Group this occupational category should be shown under e.g. office staff
 */
class JobOccupationalCategories extends \Calligraphic\Cajobboard\Admin\Model\JobOccupationalCategories
{
	/**
