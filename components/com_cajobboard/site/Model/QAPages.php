 ...
 *
 * SCHEMA: Thing
 * @property string             $name               A name for this question and question and answer page.
 * @property string             $description        A long description of this question and question and answer page.
 * @property int                $mainEntityOfPage   FK to question this page is about
 *
 * SCHEMA: CreativeWork
 * @property Organizations      $About              The organization this question-and-question and answer page is about. FK to #__cajobboard_organizations(organization_id)
 *
 * SCHEMA: QAPage
 * @property QAPageCategories   $Specialty          A category to which this question and question and answer page's content applies. FK to #__cajobboard_qapage_categories(qapage_category_id)
 *
 * RELATIONS
