<?php
/**
 * Site Job Occupational Category Groups Model
 *
 ...
 * @property string   $group                      Name this occupational category should be shown under e.g. office staff
  */
class JobOccupationalCategoryGroups extends \Calligraphic\Cajobboard\Admin\Model\JobOccupationalCategoryGroups
{
	/**
