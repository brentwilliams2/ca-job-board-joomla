...
class Html extends \FOF30\View\DataView\Html
{
  ...
  protected $componentParams;
    ...
    $lang->load('comments', JPATH_ROOT . DS . 'administrator' . DS . 'components' . DS . 'com_cajobboard', $lang->getTag(), true);

    // Load javascript file for Job Posting views
    $this->addJavascriptFile('media://com_cajobboard/js/Site/comments.js');
  }
}
