<?php
 /**
  * Places List View Item Template
  *
  ...
  */
  ...
  $address_region             = $item->address_region BIGINT UNSIGNED NOT NULL COMMENT // The name of the region, e.g. California', FK to #__cajobboard_util_address_region(address_region)
  ...
  $logoAltText                = $item->logo->name;
  // @TODO: load photo gallery (browse view of image objects)
