<?php
  ...
  */
  ...
  $terms_of_service = $this->getContainer()->template->route('index.php?Itemid=' . $params->get('terms_of_use'));
...
<div class="modal fade" id="report-item-modal" tabindex="-1" role="dialog" aria-labelledby="reportItemModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="reportItemModalLabel">
            @sprintf('COM_CAJOBBOARD_JOB_POSTINGS_REPORT_JOB_HEADER_DESC', $terms_of_service)
        </h4>
      </div>
        ...
        <form id="report-item-form">
          ...
          <div id="report-item" class="form-group">
            ...
            <textarea class="form-control" id="report-item-text-box">
                @sprintf('COM_CAJOBBOARD_JOB_POSTINGS_REPORT_JOB_USER_EMAIL_INPUT_BOX_PLACEHOLDER', $humanizedViewName . ' listing')
            </textarea>
          </div>
      ...
      <div class="modal-footer">
        <div>
          ...
          <div class="report-submit">
            @sprintf('COM_CAJOBBOARD_JOB_POSTINGS_REPORT_JOB_SUBMIT_DESC', $humanizedViewName)
          </div>
