<?php
 /**
  * Site Issue Report Categories List View Item Template
  *
...
<div class="row media @jhtml('helper.commonwidgets.getAttributeClass', 'list-item', $prefix, $crud)">
    ...
    @jhtml('helper.commonwidgets.bespokeCategory', $category, $prefix, $crud)

    @jhtml('helper.commonwidgets.url', $url, $prefix, $crud)
