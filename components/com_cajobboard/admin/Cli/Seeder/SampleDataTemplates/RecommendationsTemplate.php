<?php
/**
 * POPO Object Template for Recommendations model sample data seeding
 *
...
class RecommendationsTemplate extends CommonTemplate
{
	/**
	 * A PDF file representing this recommendation.
	 *
	 * @property    int
   */
  public $has_part__digital_document;
	...
	/**
	 * An image representing this recommendation, for example a scan of an original recommendation letter.
	 *
	 * @property    string
   */
  public $has_part__image_object;
	...
	/**
	 * The user this recommendation is about.
	 *
	 * @property    int
   */
  public $about;
