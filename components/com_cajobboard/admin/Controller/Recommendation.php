...
class Recommendation extends BaseController
{
	...
	{
    $this->modelName = 'Recommendations';
  ...
  /**
	 ...
	 */
  public function sendRecommendationRequest($request)
  {
    /*
  ...
  public function buildUrlQuery($object)
  {
    /*
      @TODO: Use a URL that has the username embedded as a query string to give to former employers as a link
            to create a recommendation, so the form doesn't have to deal with selecting the user.
