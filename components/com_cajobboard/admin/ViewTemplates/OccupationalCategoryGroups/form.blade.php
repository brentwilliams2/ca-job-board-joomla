<?php
/**
 * Occupational Category Groups Admin Edit View Template
 *
 ...
 */
  ...
  /** @var \Calligraphic\Cajobboard\Admin\Model\OccupationalCategoryGroups  $item */
  $item = $this->getItem();
?>
...
@section('advanced-options')
  {{-- OccupationalCategoryGroup Description textbox --}}
