<?php
/**
 * Admin Address Regions Edit View Template
 *
 ...
 */
  ...
  /** @var \Calligraphic\Cajobboard\Admin\Model\AddressRegions $item */
  $item = $this->getItem();
?>
...
@section('basic-options')
  <fieldset name="text" class="control-group">
      <div class="controls">
        @jhtml('helper.editWidgets.textbox', 'name', $item)
      </div>
  </fieldset>
@stop
...
@section('advanced-options')
  {{-- Application Description textbox --}}
