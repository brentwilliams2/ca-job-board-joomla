<?php
/**
 * Admin Digital Documents Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\DigitalDocuments   $item */
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Digital Document title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Digital Document title and category --}}
