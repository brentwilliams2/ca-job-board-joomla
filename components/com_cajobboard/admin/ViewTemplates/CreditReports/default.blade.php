<?php
/**
 * Credit Reports Admin Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\CreditReports  $item */
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Credit Report title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Credit Report title and category --}}
