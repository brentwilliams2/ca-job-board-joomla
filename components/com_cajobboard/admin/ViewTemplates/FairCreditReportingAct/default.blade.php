<?php
/**
 * Admin Fair Credit Reporting Acts Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\FairCreditReportingActs  $item */
...
(
  ...
  '#4'  => '35', // Fair Credit Reporting Act title
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Fair Credit Reporting Act title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Fair Credit Reporting Act title and category --}}
