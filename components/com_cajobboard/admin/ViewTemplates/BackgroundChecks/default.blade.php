<?php
/**
 * Admin Background Checks Default View Template
 *
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Background Check title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Background Check title and category --}}
