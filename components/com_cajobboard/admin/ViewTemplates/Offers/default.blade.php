<?php
/**
 * Offers Admin Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\Offers   $item */
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Offer title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Offer title and category --}}
