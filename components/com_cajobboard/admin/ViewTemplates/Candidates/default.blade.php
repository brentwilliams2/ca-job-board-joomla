<?php
/**
 * Admin Candidates Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\Candidates  $item */
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Candidate title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Candidate title and category --}}
