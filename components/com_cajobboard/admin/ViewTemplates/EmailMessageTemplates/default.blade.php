<?php
/**
 * Admin Email Message Templates Default View Template
 *
...
/** @var \Calligraphic\Cajobboard\Site\Model\EmailMessageTemplates  $item */
...
(
  ...
  '#4'  => '35', // Email Message Template title
...
@section('browse-table-header')
  <tr>
    ...
    {{-- COLUMN #4: Email Message Template title, allows sorting ASC / DESC by clicking the field name in the column header. --}}
...
@section('browse-table-body-withrecords')
  ...
  @foreach($this->items as $item)
    ...
    <tr>
      ...
      {{-- COLUMN #4: Email Message Template title and category --}}
