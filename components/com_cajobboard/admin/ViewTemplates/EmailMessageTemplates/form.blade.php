<?php
/**
 * Admin Email Message Templates Edit View Template
 *
 ...
 */
  ...
  /** @var \Calligraphic\Cajobboard\Admin\Model\EmailMessageTemplates $item */
  $item = $this->getItem();
?>
...
@section('advanced-options')
  {{-- Email Message Template Description textbox --}}
