 ...
 *
 * FOF "magic" fields
 * @property bool           $featured         Whether this application letter is featured or not.
 * @property int            $hits             Number of hits this application letter has received.
 * @property int            $created_by       Userid of the creator of this application letter.
 * @property string         $createdOn        Date this application letter was created.
 * @property int            $modifiedBy       Userid of person that last modified this application letter.
 * @property string         $modifiedOn       Date this application letter was last modified.
 *
