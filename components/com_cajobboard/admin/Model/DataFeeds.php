 ...
 *
 * FOF "magic" fields
 * @property bool           $featured         Whether this data feed is featured or not.
 * @property int            $hits             Number of hits this data feed has received.
 * @property int            $created_by       Userid of the creator of this data feed.
 * @property string         $createdOn        Date this data feed was created.
 * @property int            $modifiedBy       Userid of person that last modified this data feed.
 * @property string         $modifiedOn       Date this data feed was last modified.
 *
