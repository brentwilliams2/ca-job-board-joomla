 ...
 *
 * FOF "magic" fields
 * @property bool           $featured         Whether this application is featured or not.
 * @property int            $hits             Number of hits this application has received.
 * @property int            $created_by       Userid of the creator of this application.
 * @property string         $createdOn        Date this application was created.
 * @property int            $modifiedBy       Userid of person that last modified this application.
 * @property string         $modifiedOn       Date this application was last modified.
 *
