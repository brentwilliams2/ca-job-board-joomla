 ...
 *
 */
namespace Calligraphic\Cajobboard\Admin\Model\Vendors\Behaviour;

use \Calligraphic\Cajobboard\Admin\Helper\Enum\VendorRoleEnum;
...
class Check extends BaseCheck
{
  /**
    ...
    $this->checkForValidVendorRole($model);
  }


  /**
   * Checks for valid ENUM values in the 'role_name' field
   *
   * @param   DataModel  $model
	 */
