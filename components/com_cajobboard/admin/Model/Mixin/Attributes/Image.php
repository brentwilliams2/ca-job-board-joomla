...
{
  /**
	 * Transform 'image' field to a JRegistry object on bind
	 *
	 * @return  Registry
	 */
  protected function getImageAttribute($value)
  {
    $image = $this->transformJsonToRegistry($value);
  ...
  /**
	 * Transform 'image' field's JRegistry object to a JSON string before save
	 *
