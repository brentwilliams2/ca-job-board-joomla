 ...
 *
 * UCM
 * @property int            $task_action_id          Surrogate primary key.
 ...
 *
 * SCHEMA: Thing
 * @property string         $name             A title to use for the task action.
 * @property string         $description      A description of the task action.
 */
class TaskActions extends BaseDataModel
{
  use \FOF30\Model\Mixin\Assertions;
    ...
    // Not using convention for table names or primary key field
		$config['tableName'] = '#__cajobboard_task_actions';
    $config['idFieldName'] = 'task_action_id';

    // Define a contentType to enable the Tags behaviour
    $config['contentType'] = 'com_cajobboard.task_actions';
