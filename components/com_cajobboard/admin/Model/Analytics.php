...
class Analytics extends BaseModel
{
  use \FOF30\Model\Mixin\Assertions;
    ...
    // Not using convention for table names or primary key field
		$config['tableName'] = '#__cajobboard_analytics';
    $config['idFieldName'] = 'analytic_id';

    // Define a contentType to enable the Tags behaviour
    $config['contentType'] = 'com_cajobboard.analytics';
  ...
  /**
	...
	{
    $this->assertNotEmpty($this->name, 'COM_CAJOBBOARD_ANALYTICS_TITLE_ERR');
