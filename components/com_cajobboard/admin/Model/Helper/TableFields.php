  ...
  * Public class constructor
  ...
  private function employer_aggregate_ratingsTableFieldMetadata()
  {
    return array(
      ...
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'rating_count'                 => (object) ['Field' => 'rating_count',                 'Type' => 'int(11)',           'Null' => 'NO',   'Default' => '0'],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'review_count'                 => (object) ['Field' => 'review_count',                 'Type' => 'int(11)',           'Null' => 'NO',   'Default' => '0'],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'rating_value'                 => (object) ['Field' => 'rating_value',                 'Type' => 'int(11)',           'Null' => 'NO',   'Default' => '0'],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
    );
  }
