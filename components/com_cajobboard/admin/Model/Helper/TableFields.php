...
class TableFields
{
  ...
  * Public class constructor
  ...
  public function getTableFieldsMetadata($model)
  {
    ...
    // Don't use common fields for models that don't implement all Joomla! UCM fields
    if (
  ...
  private function image_objectsTableFieldMetadata()
  {
    return array(
      ...
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'height'                      => (object) ['Field' => 'height',                   'Type' => 'int',                    'Null' => 'YES',  'Default' => NULL],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'width'                       => (object) ['Field' => 'width',                    'Type' => 'int',                    'Null' => 'YES',  'Default' => NULL],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'encodingFormat'              => (object) ['Field' => 'encodingFormat',           'Type' => 'char(32)',               'Null' => 'YES',  'Default' => NULL],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  private function messagesTableFieldMetadata()
  {
    return array(
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
        'about__foreign_model_id'   => (object) ['Field' => 'about__foreign_model_id',      'Null' => 'YES',  'Type' => 'bigint(20)',            'Default' => NULL],
      //------------------------------------------------------------------------------------------------------------------------------------------------------------
