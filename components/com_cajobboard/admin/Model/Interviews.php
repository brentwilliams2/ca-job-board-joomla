 ...
 *
 * FOF "magic" fields
 * @property bool           $featured         Whether this interview is featured or not.
 * @property int            $hits             Number of hits this interview has received.
 * @property int            $created_by       Userid of the creator of this interview.
 * @property string         $createdOn        Date this interview was created.
 * @property int            $modifiedBy       Userid of person that last modified this interview.
 * @property string         $modifiedOn       Date this interview was last modified.
 *
...
class Interviews extends BaseModel
{
  use \FOF30\Model\Mixin\Assertions;
    ...
    $config['contentType'] = 'com_cajobboard.interviews';
