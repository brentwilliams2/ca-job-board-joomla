 ...
 *
 */
namespace Calligraphic\Cajobboard\Admin\Model\Behaviour\OccupationalCategoryGroups;
...
class Check extends BaseCheck
{
  ...
  /**
    ...
    $this->assertNotEmpty( $model->getFieldValue('url'), 'COM_CAJOBBOARD_OCCUPATIONAL_CATEGORY_ERR_CODE' );
		$this->assertNotEmpty( $model->getFieldValue('group'), 'COM_CAJOBBOARD_OCCUPATIONAL_CATEGORY_ERR_GROUP' );
  }
}
