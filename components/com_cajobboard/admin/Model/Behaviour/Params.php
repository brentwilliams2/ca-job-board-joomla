 ...
 * 'params' table field, and to do any operations useful for it
 *
...
class Params extends Observer
{
  /**
	...
	{
    $paramsField= $item->getFieldAlias('params');

    if ( $item->hasField($paramsField) )
    {
      $item->addSkipCheckField($paramsField);
    }
  }
}