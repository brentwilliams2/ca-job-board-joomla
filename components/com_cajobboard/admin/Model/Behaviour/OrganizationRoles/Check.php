 ...
 *
 */
namespace Calligraphic\Cajobboard\Admin\Model\Behaviour\OrganizationRoles;
...
class Check extends BaseCheck
{
  ...
  /**
    ...
    parent::onCheck($model);
		...
		$this->assertNotEmpty( $model->getFieldValue('role_name'), 'COM_CAJOBBOARD_ORGANIZATION_ROLES_ERR_ROLE_NAME' );
    $this->assertNotEmpty( $model->getFieldValue('url'), 'COM_CAJOBBOARD_ORGANIZATION_ROLES_ERR_URL' );
  }
}
