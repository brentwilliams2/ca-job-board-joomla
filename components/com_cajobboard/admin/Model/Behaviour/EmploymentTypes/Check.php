 ...
 *
 */
namespace Calligraphic\Cajobboard\Admin\Model\Behaviour\EmploymentTypes;
...
class Check extends BaseCheck
{
   ...
   * @param   DataModel  $model
	...
	{
    $this->assertNotEmpty($model->getFieldValue('name'), 'COM_CAJOBBOARD_EMPLOYMENT_TYPE_ERR_TITLE');
    $this->assertNotEmpty($model->getFieldValue('description'), 'COM_CAJOBBOARD_EMPLOYMENT_TYPE_ERR_DESCRIPTION');
    $this->assertNotEmpty($model->getFieldValue('url'), 'COM_CAJOBBOARD_EMPLOYMENT_TYPE_ERR_URL');
  }
}
