 ...
 *
 */
namespace Calligraphic\Cajobboard\Admin\Model\BackgroundChecks\Behaviour;
...
class Check extends BaseCheck
{
   ...
   * @param   DataModel  $model
    ...
    if ( is_string($actionStatusName) )
    {
      $actionStatusName = self::getValueForConstant($actionStatusName);
    }
