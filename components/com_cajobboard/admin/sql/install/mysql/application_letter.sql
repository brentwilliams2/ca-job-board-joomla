...
CREATE TABLE IF NOT EXISTS `#__cajobboard_application_letters` (
  application_letter_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key',
  ...
  /* SCHEMA: CreativeWork */
  encoding_format CHAR(32) COMMENT 'MIME format of the application letter, e.g. application/pdf.',
...
VALUES(
  ...
  '{
    ...
    "special":{
      ...
      "about__organization_id":"about__organization_id"
    }
  }',
  /* router */
  '',
