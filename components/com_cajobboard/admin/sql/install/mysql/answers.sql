...
CREATE TABLE IF NOT EXISTS `#__cajobboard_answers` (
  ...
  note TEXT COMMENT 'A note to save with this item for use in the back-end interface.',
  ...
  about__foreign_model_id BIGINT UNSIGNED COMMENT 'The primary key of the foreign model item that this answer belongs to, e.g. QAPages, Interviews, or Applications.',
  about__foreign_model_name VARCHAR(255) COMMENT 'The name of the foreign model this answer belongs to, discriminator field for single-table inheritance.',

  /* SCHEMA: CreativeWork */
  is_part_of__question BIGINT UNSIGNED COMMENT 'This property points to a Question entity associated with this answer. FK to #__cajobboard_questions.',
