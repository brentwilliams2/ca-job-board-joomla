 ...
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_offers` (
  offer_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key',
  ...
  /* SCHEMA: Thing */
  about__person BIGINT(20) UNSIGNED COMMENT 'The person the job offer is extended to.', /* FK to #__cajobboard_persons */
  ...
  /* SCHEMA: Offer */
  valid_through DATETIME COMMENT 'The date this job offer is valid until.',
  item_offered BIGINT(20) UNSIGNED COMMENT 'The Job Posting that this offer is being made for.', /* FK to #__cajobboard_job_postings */
  offered_by BIGINT(20) UNSIGNED COMMENT 'The Employer making this job offer.', /* FK to #__cajobboard_organizations */
  includes_object__digital_document BIGINT(20) UNSIGNED COMMENT 'The offer letter document.', /* FK to #__cajobboard_digital_documents */
  includes_object__email_message BIGINT(20) UNSIGNED COMMENT 'The email message extending the offer to the job seeker.', /* FK to #__cajobboard_email_messages */

  /* SCHEMA: Offer(price) -> JobPosting (baseSalary) */
  price__base_salary__value FLOAT COMMENT 'The base salary of the job.',
  price__base_salary__currency CHAR(6) COMMENT 'Currency the job is paid in, use ISO 4217 currency format e.g. USD.',

  /* SCHEMA: Offer(price) -> JobPosting (baseSalary) -> MonetaryAmount (additionalType) -> Duration */
  price__base_salary__duration CHAR(32) COMMENT 'Pay period for the job, use ISO 8601 duration format, e.g. P2W for bi-weekly.',
...
/**
 * Create content types for Offers, mapping fields to the UCM standard fields for history feature
 *
...
/*
 * Offers content type for history component
 */
...
VALUES(
  ...
  '{
    ...
    "special":{
      ...
      "includes_object__digital_document":"includes_object__digital_document",
      "includes_object__email_message":"includes_object__email_message",
      "item_offered":"item_offered",
      "note":"note",
      "offered_by":"offered_by",
      "price__base_salary__currency":"price__base_salary__currency",
      "price__base_salary__duration":"price__base_salary__duration",
      "price__base_salary__value":"price__base_salary__value",
