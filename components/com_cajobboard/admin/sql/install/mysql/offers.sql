...
CREATE TABLE IF NOT EXISTS `#__cajobboard_offers` (
  ...
  /* SCHEMA: Thing */
  about BIGINT(20) UNSIGNED COMMENT 'The person the offer is being conducted on', /* FK to #__cajobboard_persons */

organization 
/* SCHEMA: Thing(potentialAction) -> BuyAction */
vendor BIGINT(20) UNSIGNED COMMENT 'The organization that will provide offer services for this item.',  /* FK to #__cajobboard_organizations */
  ...
  end_time DATETIME DEFAULT NULL COMMENT 'The date the completed offer was received.',
  result BIGINT(20) UNSIGNED COMMENT 'The digital document returned from the offering service as a result', /* FK to #__cajobboard_digital_documents */
  start_time DATETIME DEFAULT NULL COMMENT 'The date the offer was requested.',
