...
CREATE TABLE IF NOT EXISTS `#__cajobboard_questions` (
  ...
  note TEXT COMMENT 'A note to save with this question in the back-end interface.',
  ...
  description TEXT COMMENT 'Description of the question.',
  ...
  /* SCHEMA: CreativeWork */
  publisher BIGINT UNSIGNED COMMENT 'The company that wrote this answer. FK to #__organizations.',
  `text` TEXT COMMENT 'The actual text of the question itself.',

  /* SCHEMA: Question */
  accepted_answer BIGINT UNSIGNED COMMENT 'Use acceptedAnswer for the best answer to a question.  FK to #__cajobboard_answers.',
...
VALUES(
  ...
  '{
    "common":{
      ...
      "core_content_item_id":"question_id",
