...
/**
 * Alerts data model SQL
 *
 * Uses schema https://calligraphic.design/schema/Alert
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_alerts` (
  alert_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
