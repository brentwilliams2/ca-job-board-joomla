...
/**
 * Application data model SQL
 *
 * Uses schema https://calligraphic.design/schema/Application
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_applications` (
  application_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
  ...
  note VARCHAR(255) COMMENT 'A note to save with this application in the back-end interface.',
...
/*
 * Create content types for Applications, mapping fields to the UCM standard fields for history feature
 *
...
/*
 * Applications content type for history component
 */
...
VALUES(
  ...
  '{
    "common":{
        "core_content_item_id":"application_id",
        "core_title":"name",
        "core_state":"enabled",
        "core_alias":"slug",
