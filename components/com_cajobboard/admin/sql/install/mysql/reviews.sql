...
CREATE TABLE IF NOT EXISTS `#__cajobboard_reviews` (
  ...
  note TEXT COMMENT 'A note to save with this review in the back-end interface.',

  /* SCHEMA: Thing */
  name VARCHAR(255) NOT NULL COMMENT 'A name for this review.',
  description TEXT COMMENT 'Description of this review.',
