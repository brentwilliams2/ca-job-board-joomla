...
CREATE TABLE IF NOT EXISTS `#__cajobboard_employer_aggregate_ratings` (
  ...
  /* SCHEMA: Rating */
  rating_value   INT COMMENT 'The total rating sum for this employer. Get average by dividing with rating_count. Default worstRating 1 and bestRating 5 assumed.',
