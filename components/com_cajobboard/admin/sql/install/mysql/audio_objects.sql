...
/**
 * Audio Object data model SQL
 *
 * Uses schema https://schema.org/AudioObject
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_audio_objects` (
...
/*
 * Audio Objects content type for history component
 */
