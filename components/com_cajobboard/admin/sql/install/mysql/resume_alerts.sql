...
/**
 * Resume Alerts data model SQL
 *
 * Job Seeker alerts by category, geographic proximity (e.g. within one mile)
 *
 * Uses schema https://calligraphic.design/schema/Alert
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_resume_alerts` (
  resume_alert_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
