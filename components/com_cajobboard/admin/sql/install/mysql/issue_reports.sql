 ...
 */
 ...
 /**
 * Issue Reports table for abusive content reports
 *
 * Uses schema https://calligraphic.design/schema/ReportIssue
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_issue_reports` (
...
/*
 * Issue Reports content type for history component
 */
...
VALUES(
  ...
  '{
    "special":{
      "dbtable":"#__cajobboard_issue_reports",
      "key":"issue_report_id",
      "type":"Report",
      "prefix":"IssueReportsTable",
      "config":"array()"
    },
    "common":{
