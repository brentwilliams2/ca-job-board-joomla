 ...
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_task_actions` (
  task_action_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
  ...
  note VARCHAR(255) COMMENT 'A note to save with this task action in the back-end interface.',
...
/* SCHEMA: CreativeWork */
  ...
  /* @TODO: we're duplicating Actions in BackgroundChecks / CreditReports, and in the Task for those. But we need some metadata in those models about the action: e.g. Vendor  */
