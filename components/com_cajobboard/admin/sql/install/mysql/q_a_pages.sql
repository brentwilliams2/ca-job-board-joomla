 ...
 */
  ...
  *
  * QAPages point to a single question and its associated answers, browse view to see all questions
  *
  * Uses schema https://schema.org/QAPage
  */
CREATE TABLE IF NOT EXISTS `#__cajobboard_q_a_pages` (
  q_a_page_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
  ...
  note TEXT COMMENT 'A note to save with this question-and-answer page in the back-end interface.',
  ...
  /* SCHEMA: CreativeWork */
  about__organization BIGINT UNSIGNED COMMENT 'The organization this question-and-answer page is about. FK to #__cajobboard_organizations',

  /* SQL DDL */
  PRIMARY KEY (q_a_page_id)
)
  ENGINE=innoDB
