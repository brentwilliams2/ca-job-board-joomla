...
CREATE TABLE IF NOT EXISTS `#__cajobboard_issues` (
  ...
  note VARCHAR(255) COMMENT 'A note to save with this issue in the back-end interface.',
  ...
  description TEXT COMMENT 'Short description of the issue, used for the text shown on social media via shares and search engine results.',
...
/*
 * Create content types for Issues, mapping fields to the UCM standard fields for history feature
 *
...
/*
 * Issues content type for history component
 */
