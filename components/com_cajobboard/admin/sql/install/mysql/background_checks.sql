 ...
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_background_checks` (
  background_check_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key',
  ...
  /* SCHEMA: Thing */
  about BIGINT(20) UNSIGNED COMMENT 'The person the background check is being conducted on', /* FK to #__cajobboard_persons */
  ...
  price INT COMMENT 'The actual cost of the background check from the vendor.',

  /* SCHEMA: Thing(potentialAction) -> BuyAction */
  vendor BIGINT(20) UNSIGNED COMMENT 'The organization that will provide background check services for this item.',  /* FK to #__cajobboard_organizations */
