...
/**
 * Schedules data model SQL
 *
 * Uses schema https://calligraphic.design/schema/Schedule
 */
CREATE TABLE IF NOT EXISTS `#__cajobboard_schedules` (
  schedule_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Surrogate primary key', /* FK to #__cajobboard_ucm(id) */
  ...
  note VARCHAR(255) COMMENT 'A note to save with this schedule in the back-end interface.',
