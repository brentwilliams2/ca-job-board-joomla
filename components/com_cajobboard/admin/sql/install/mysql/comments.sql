...
CREATE TABLE IF NOT EXISTS `#__cajobboard_comments` (
  ...
  /* SCHEMA: Thing */
  name VARCHAR(255) COMMENT 'A title for this comment.',
  description TEXT COMMENT 'A short description of this comment.',

  /* SCHEMA: Comment */
  parent_item BIGINT UNSIGNED NOT NULL DEFAULT '0' COMMENT 'The comment this comment is a child of, or zero if a top-level comment',
  upvote_count INT UNSIGNED COMMENT 'The number of upvotes this comment has received from the community.',
  downvote_count INT UNSIGNED COMMENT 'The number of downvotes this comment has received from the community.',

  /* SCHEMA: CreativeWork */
  about__model VARCHAR(50) NOT NULL COMMENT 'The model name this comment refers to.',
  about__id BIGINT UNSIGNED NOT NULL COMMENT 'The entity id in the foreign model this comment refers to.',
  `text` TEXT COMMENT 'The full text of this comment.',
