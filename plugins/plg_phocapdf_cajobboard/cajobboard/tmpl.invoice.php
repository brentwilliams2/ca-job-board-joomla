<?php
/**
 * Plugin to enable PDF views (removed in Joomla 3.x)
 *
...
class PhocaPDFCajobboardInvoice {
...
$o .= '<div style="font-size: large;color: #777777;">           '.JText::_('PLG_PHOCAPDF_VM_DELIVERY_PRINT_SIGNED_LBL').':   <span>_________________</span></div>';
...
.'<td align="center" width="45%">'
  ...
  .'<table>'
   ...
   .'<tr>'
    .'<td class="documenthead">'.JText::_('PLG_PHOCAPDF_VM_DELIVERY_PRINT_INVOICE_DATE_LBL').'</td>'
...
.'<tr width="100%">'
 ...
 .'<td width="20%">'.JText::_('PLG_PHOCAPDF_VM_DELIVERY_PRINT_BILL_TERMS_LBL').': </td><td width="25%">'.$a['due_date'].' '.JText::_('PLG_PHOCAPDF_VM_DELIVERY_DAYS').'</td>'
.'</tr>'

.'<tr width="100%">'
 .'<td width="20%">'.JText::_('PLG_PHOCAPDF_VM_DELIVERY_PRINT_SHIPPING_MODE_LBL').': </td><td width="35%">'.$a['details_2'].'</td>'
 .'<td width="20%">'.JText::_('PLG_PHOCAPDF_VM_DELIVERY_PRINT_OVERDUE_INTEREST_LBL').': </td><td width="25%">'.$a['delay_interest'].'</td>'
.'</tr>'
.'</table>';
